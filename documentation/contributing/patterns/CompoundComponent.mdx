...
<Meta title="Contributing/Patterns/Compound Component" />
...
import { MyTabs } from '@spark-ui/tabs'
...
- It needs a single import `import { Tabs } from '@spark-ui/tabs` to work. Instead of something like `import { Tabs, TabsTrigger, TabsList, etc... }`
